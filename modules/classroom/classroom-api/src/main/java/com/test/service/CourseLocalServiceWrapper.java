...
public class CourseLocalServiceWrapper
	 ...
	 */
	@Override
	public com.test.model.Course addCourse(com.test.model.Course course) {
	 ...
	 */
	@Override
	public com.test.model.Course createCourse(long courseId) {
	 ...
	 */
	@Override
	public com.test.model.Course deleteCourse(long courseId)
		throws com.liferay.portal.kernel.exception.PortalException {
	...
	public java.util.List<com.test.model.Course> getAllCourses() {
		return _courseLocalService.getAllCourses();
	}
	 ...
	 */
	@Override
	public com.test.model.Course getCourse(long courseId)
		throws com.liferay.portal.kernel.exception.PortalException {
	 ...
	 */
	@Override
	public java.util.List<com.test.model.Course> getCourses(
		int start, int end) {
	 ...
	 */
	@Override
	public com.test.model.Course updateCourse(com.test.model.Course course) {
