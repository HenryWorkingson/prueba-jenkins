...
package com.cofares.test.service.persistence;
...
public class FooUtil {
	...
	public static Foo findByUuid_First(
		...
		throws com.cofares.test.exception.NoSuchFooException {
