 ...
 * <code>com.test.service.impl.CourseSessionLocalServiceImpl</code> and
...
public class CourseSessionLocalServiceUtil {
	 ...
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify this class directly. Add custom service methods to <code>com.test.service.impl.CourseSessionLocalServiceImpl</code> and rerun ServiceBuilder to regenerate this class.
	 */
	 ...
	 */
	public static CourseSession addCourseSession(CourseSession courseSession) {
	 ...
	 */
	public static CourseSession createCourseSession(long courseSessionId) {
	 ...
	 */
	public static CourseSession deleteCourseSession(
	 ...
	 */
	public static CourseSession deleteCourseSession(long courseSessionId)
		throws PortalException {
	...
	public static CourseSession fetchCourseSession(long courseSessionId) {
	 ...
	 * @throws PortalException if a course session with the primary key could not be found
	 */
	public static CourseSession getCourseSession(long courseSessionId)
		throws PortalException {
	 ...
	 */
	public static List<CourseSession> getCourseSessions(int start, int end) {
	 ...
	 */
	public static CourseSession updateCourseSession(
		CourseSession courseSession) {
	...
	private static volatile CourseSessionLocalService _service;
