...
public class CourseSessionUtil {
	...
	public static CourseSession findByCourseId_First(
		...
		throws com.test.exception.NoSuchCourseSessionException {
	...
	private static volatile CourseSessionPersistence _persistence;
